...
class block_mystream extends block_base {
    ...
    public function get_content() {
        ...
        $output = $this->page->get_renderer('block_mystream'); // Global $PAGE is preloaded into $this->page.
    ...
    public function old_get_content() {
        global $CFG;
        ...
        $this->content = new stdClass;
        $text = new \block_mystream\stream_data('calendar');
        ...
        if (!empty($this->instance)) {
            ...
            $text->content = calendar_get_block_upcoming($events, $link, $showcourselink);
        }

        if (empty($text->content)) {
            $text->content = '<div class="post">'. get_string('noupcomingevents', 'calendar').'</div>';
        }
